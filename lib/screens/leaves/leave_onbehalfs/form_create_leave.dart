...
class FormOnbehalfLeavePage extends ConsumerStatefulWidget {
  @override
  _OnbehalfLeavePageState createState() => _OnbehalfLeavePageState();
}

class _OnbehalfLeavePageState extends ConsumerState<FormOnbehalfLeavePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          AppLocalizations.of(context)!.requestLeaveOnbehalf,
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            final result = await ref
                                ...
                                .createOnbehalfRequest(request, context);
                            setState(() {
                              _isApplying = false;
                            });
                          } finally {

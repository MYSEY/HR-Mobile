...
final trainingProvider =
    StateNotifierProvider<EmployeeNotifier, List<StaffTraining>>((ref) {
  return EmployeeNotifier(ref);
});

class EmployeeNotifier extends StateNotifier<List<StaffTraining>> {
  ...
  Future<void> fetchTrainings() async {
    try {
      ...
      if (responseData != null && responseData['datas'] is List) {
        ...
        print("datas: $datas");
        state = (datas as List).map((e) => StaffTraining.fromJson(e)).toList();
      } else {
